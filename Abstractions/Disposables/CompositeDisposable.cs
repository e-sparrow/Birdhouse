...
namespace Birdhouse.Abstractions.Disposables
{
    ...
    {
        public CompositeDisposable() => _disposables = new List<IDisposable>();
        public CompositeDisposable(IEnumerable<IDisposable> disposables) => _disposables = new List<IDisposable>(disposables);
        ...
        public void Dispose() => _disposables.Foreach(value => value.Dispose());
    }
}