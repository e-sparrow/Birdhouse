...
namespace Birdhouse.Common.Extensions
{
    public static class UniversalExtensions
    {
        ...
        public static IDisposable AddAsDisposable<T>(this T self, ICollection<T> collection)
        {
        ...
        public static IDisposable AddAsDisposables<T>(this IEnumerable<T> self, ICollection<T> collection)
        {
            IDisposable result = new CallbackDisposable();
            foreach (var value in self)
            {
                var disposable = value.AddAsDisposable(collection);
